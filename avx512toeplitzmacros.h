...
void _mm512_madd52_epu64(__m512i* rethi, __m512i* retlo, __m512i op1, __m512i op2)
{
	...
	*rethi = _mm512_madd52hi_epu64(*rethi, op1, op2);
	#if N == 48 || N == 64 || N == 80 || N == 120
	uint8_t signmask2 = _mm512_movepi64_mask(op2);
	*rethi = _mm512_mask_sub_epi64(*rethi, signmask2, *rethi, op1);
	#endif
}
...
#define TOEP33TOP(X, F) {\
	...
	F (t0hi, t0, vect + 2*X/24, m034);\
	F (t1hi, t1, vect + X/24, m013);\
	F (t2hi, t2, vect, m012);\
...
#define TOEP55TOP(X, F) {\
	...
	F (t0hi, t0, vect + 4*X/40, m87650);\
	F (t1hi, t1, vect + 3*X/40, m76501);\
	F (t2hi, t2, vect + 2*X/40, m65012);\
	F (t3hi, t3, vect + 1*X/40, m50123);\
	F (t4hi, t4, vect        , m01234);\
